...
{
    public class UsualChargeTask : ChargeBase
    {
        private IOutput Output;

        public UsualChargeTask(BatteryBase batteryBase, IOutput output):base(batteryBase)
        {
            Output = output;
        }
        ...
        {
            Output.WriteLine($"{nameof(UsualChargeTask)} charging fast");
        }
    }
}
